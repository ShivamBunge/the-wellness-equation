...
export default function Category({ category }: { category: string }) {
  ...
  return (
    <button
      ...
      className={`my-2 mr-6 cursor-pointer rounded-full px-6 py-2 ring-[#968FC3] transition-all duration-300 hover:ring-offset-4 dark:ring-offset-customGray-dark ${
        checked
